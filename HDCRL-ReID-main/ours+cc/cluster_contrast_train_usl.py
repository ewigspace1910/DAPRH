...
def create_model(args):
    ...
    model_ema = models.create(args.arch, num_features=args.features, norm=True, dropout=args.dropout, num_classes=0, pooling_type=args.pooling_type)
...
def main_worker(args):
    ...
    # Trainer
    trainer = ClusterContrastTrainer(model, model_ema)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--data-dir', type=str, metavar='PATH',
                        default='../Mean-Hard-Teacher/data')
    parser.add_argument('--logs-dir', type=str, metavar='PATH',
                        default=osp.join(working_dir, 'logs'))
    parser.add_argument('--pooling-type', type=str, default='avg')
    parser.add_argument('--use-hard', type=bool, default=True)
    main()

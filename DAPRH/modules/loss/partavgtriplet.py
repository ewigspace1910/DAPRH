...
from .triplet import _batch_hard, euclidean_dist, cosine_dist
...
class PartAveragedTripletLoss(nn.Module):
    ...
    def __init__(self, margin=0.3, epsilon=1e-16, **kwargs):
    ...
    def forward(self, part_based_embeddings, labels, **kwargs):
        """
    ...
    def _hard_mine_triplet_loss(self, batch_pairwise_dist, labels, margin):
        ...
        # print(valid_pairwise_dist_mask)
    ...
    def _get_anchor_positive_mask(labels):
        ...
        mask_anchor_positive = indices_not_equal_mask * labels_equal_mask #-> exclude label on diagonal line

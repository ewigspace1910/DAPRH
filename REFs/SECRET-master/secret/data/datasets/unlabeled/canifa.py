...
class Canifa(BaseImageDataset):
    '''
    this is own private dataset
    '''
    dataset_dir = 'UnlabelDS_canifa'

    def __init__(self, root="./datasets", verbose=True, **kwargs):
        super(Canifa, self).__init__()
        self.dataset_name = 'Canifa_UnlabelDS'
        ...
        gallery = self._process_dir_train(self.gallery_dir, relabel=False)
